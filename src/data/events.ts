...
export const events: CultureEvent[] = [
  ...
  },
  {
    ...
    isFree: true,
    description:
      "한국 추상미술의 선구자 유영국 탄생 110주년을 기념하는 역대 최대 규모의 회고전입니다. 미공개작을 포함한 회화, 부조, 사진, 드로잉과 아카이브 170여 점으로 1935년 도쿄에서 시작된 추상 실험부터 생애 후반의 심상 추상까지 60여 년의 화업을 총체적으로 살핍니다.",
  ...
  },
  {
    ...
    isFree: false,
    description:
      "제60회 베니스 비엔날레 한국관 대표 작가 구정아의 대규모 개인전입니다. 자력이나 향처럼 눈에 보이지 않지만 존재하는 에너지의 흐름을 탐구하며, 세밀하면서도 모호하게 감각의 질서를 교란하는 독창적 작업을 M2 전관에서 선보입니다.",
