...
export const uiCopy = {
  ko: {
    ...
    home: {
      title: ["당신의 문화생활을", "더 특별하게"],
      intro: ["음악, 전시, 축제와 새로운 공간.", "지금 서울에서 열리는 장면을 모았습니다."],
      exploreMap: "지도에서 둘러보기",
      weeklyExhibitions: "이번 주 추천 문화 3곳",
      weeklyExhibitionsIntro: ["전시부터 사운드 공간까지 엄선한 세 곳.", "공식 이미지와 상세 정보가 확인된 장소만 골랐습니다."],
  ...
  en: {
    ...
    home: {
      title: ["Make your cultural life", "more special"],
      intro: ["Music, exhibitions, festivals and new spaces.", "A selection of scenes unfolding across Seoul now."],
      exploreMap: "Explore the map",
      weeklyExhibitions: "Three cultural picks this week",
      weeklyExhibitionsIntro: ["Three considered picks, from exhibitions to sound.", "Each has verified details and official imagery."],
      manifesto: ["SEE", "HEAR", "GATHER"],
